...
if(breakOn==HIGH){if(digitalRead(33)==LOW){Serial.println(">>>>>LEFT Break Release:");breakRelease=HIGH;breakOn=LOW;breakOn=LOW;}} else
...
////////////Serial.print("Boot Time: ");Serial.println(millis());
    ...
    BLEDevice::getScan()->start(0);///*//0  // this is just eample to start scan after disconnect, most likely there is better way to do it in arduino
}
////////////////////////////////////
if(sleepOff==LOW){
...
Serial.print("READ EEPROM: ");Serial.println(list);delay(10);
return list;}
